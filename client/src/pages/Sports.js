            ...
            <div className="flex-column justify-space-between p-3">
                <section className="card">
                    ...
                    <meat className="container flex-row justify-space-between">
                            <img src={spurs} className="display-inline" style={{ width: "40%"}} alt="example"/>
                ...
                <section className="card">
                    ...
                    <div className="card-body">
                    <meat className="container flex-row justify-space-between">
                            <img src={missions} className="display-inline" style={{ width: "40%"}} alt="example"/>
                ...
                <section className="card">
                    ...
                    <div className="card-body">
                    <meat className="container flex-row justify-space-between">
                            <img src={safc} className="display-inline" style={{ width: "40%"}} alt="example"/>
                ...
                <section className="card">
                    ...
                    <div className="card-body">
                    <meat className="container flex-row justify-space-between">
                            <img src={utsa} className="display-inline" style={{ width: "40%"}} alt="example"/>
                ...
                <section className="card">
                    ...
                    <div className="card-body">
                    <meat className="container flex-row justify-space-between">
                            <img src={brahmas} className="display-inline" style={{ width: "40%"}} alt="example"/>
